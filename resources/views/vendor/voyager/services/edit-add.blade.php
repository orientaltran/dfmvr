        ...
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.services.update', $dataTypeContent->id) }}@else{{ route('voyager.services.store') }}@endif" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i> {{ __('service.title') }}
                                <span class="panel-desc"> {{ __('service.title_sub') }}</span>
                            </h3>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{{ __('service.content') }}</h3>
                            <div class="panel-actions">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{!! __('service.excerpt') !!}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                    ...
                    {{--<div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{{ __('service.additional_fields') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i> {{ __('service.details') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="form-group">
                                <label for="slug">{{ __('service.slug') }}</label>
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'slug',
                            ...
                            <div class="form-group">
                                <label for="status">{{ __('service.status') }}</label>
            ...
            <button type="submit" class="btn btn-primary pull-right">
                @if(isset($dataTypeContent->id)){{ __('service.update') }}@else <i class="icon wb-plus-circle"></i> {{ __('service.new') }} @endif
            </button>
        </form>
