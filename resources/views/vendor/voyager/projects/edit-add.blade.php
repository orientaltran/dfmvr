        ...
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.projects.update', $dataTypeContent->id) }}@else{{ route('voyager.projects.store') }}@endif" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i> {{ __('project.title') }}
                                <span class="panel-desc"> {{ __('project.title_sub') }}</span>
                            </h3>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{{ __('project.content') }}</h3>
                            <div class="panel-actions">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{!! __('project.excerpt') !!}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                    ...
                    {{--<div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{{ __('project.additional_fields') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i> {{ __('project.details') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-image"></i> {{ __('project.image') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
            ...
            <button type="submit" class="btn btn-primary pull-right">
                @if(isset($dataTypeContent->id)){{ __('project.update') }}@else <i class="icon wb-plus-circle"></i> {{ __('project.new') }} @endif
            </button>
        </form>
